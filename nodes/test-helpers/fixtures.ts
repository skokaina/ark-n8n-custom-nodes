...
export const mockAgentExecuteRequest = {
  input: 'Hello, what can you do?',
  wait: true,
  timeout: '30s',
};

export const mockAgentExecuteResponseSuccess = {
...
export const mockAgentExecuteResponseFailed = {
  queryName: 'test-agent-abc123',
  input: 'Hello, what can you do?',
  status: 'failed',
  duration: '1.0s',
...
export const mockAgentExecuteResponseTimeout = {
  queryName: 'test-agent-abc123',
  input: 'Hello, what can you do?',
  status: 'timeout',
  duration: '30s',
...
export const mockAgentExecuteResponseAsync = {
  queryName: 'test-agent-abc123',
  input: 'Hello, what can you do?',
  status: 'pending',
  duration: null,
...
export const mockModelExecuteRequest = {
  prompt: 'What is 2+2?',
  temperature: 0.7,
  maxTokens: 100,
};

export const mockModelExecuteResponse = {
...
export const mockTeamExecuteRequest = {
  input: 'Coordinate a task',
  wait: true,
};

export const mockTeamExecuteResponse = {
...
export const evaluatorsListFixture = {
  items: [
    {
...
export const directEvaluationFixture = {
  name: 'eval-test-123',
  namespace: 'default',
  type: 'direct',
  spec: {
...
export const queryEvaluationFixture = {
  name: 'eval-query-456',
  namespace: 'default',
  type: 'query',
  spec: {
